...
export class Contract extends ethereum.SmartContract {
  ...
  CANNOT_TRANSFER_TO_ZERO_ADDRESS(): string {
  ...
  try_CANNOT_TRANSFER_TO_ZERO_ADDRESS(): ethereum.CallResult<string> {
  ...
  try_NOT_CURRENT_OWNER(): ethereum.CallResult<string> {
    let result = super.tryCall(
      "NOT_CURRENT_OWNER",
      "NOT_CURRENT_OWNER():(string)",
      []
